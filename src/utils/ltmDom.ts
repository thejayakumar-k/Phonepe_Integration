...
export const MOTO_SVG_MARKUP =
  ...
  '<rect x="4" y="13" width="22" height="13" rx="2" fill="#0ea5e9" stroke="#0284c7" stroke-width="1"/>' +
  '<text x="15" y="21.5" font-size="3.4" font-family="sans-serif" font-weight="bold" fill="white" text-anchor="middle" letter-spacing="-0.3">OORUNII</text>' +
  // Rider body
