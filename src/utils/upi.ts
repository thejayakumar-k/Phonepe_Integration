...
/**
 * Generate a Google Pay (Tez) deep link. Opens GPay directly with the
 * payee + amount pre-filled, equivalent to scanning the QR.
 */
export function generateGpayString(
  merchant: MerchantConfig,
  amount?: number,
  orderId?: string,
  note?: string
